...
contract VervFluxCrowdsale is CappedCrowdsale, Ownable, Pausable {
        ...
        CappedCrowdsale(_cap)
    {
        ...
        // Define tokens percentage retained by company and bounty
        finalizationRetainStrategy[companyWallet] = 33;
        finalizationRetainStrategy[bountyWallet] = 1;
        ...
        atStage(Stages.SaleOver)
    {
        ...
        uint256 bountyRetainPerc = finalizationRetainStrategy[bountyWallet];
        uint256 tokensDistributed = token.totalSupply();
        uint256 investorsMarge = 100 - campanyRetainPerc - bountyRetainPerc;
        ...
        uint256 bountyDist = totalTokens * bountyRetainPerc / 100;

        token.mint(companyWallet, companyDist);
        token.mint(bountyWallet, bountyDist);
